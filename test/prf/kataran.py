...
class KatranTest(P4EbpfTest):
    p4_file_path = "../P4-Kataran/main.p4"
    p4info_reference_file_path = "..../P4-Kataran/maininfo.txtpb"
    session_installed = False

    def setUp(self):
        super(KatranTest, self).setUp()

    def tearDown(self):
        super(KatranTest, self).tearDown()
...
'''
class IPoIPstreamTest(KatranTest):
...
'''
class IPv4streamTest(KatranTest):
    def doRunTest(self, pkt):
